...
const size_t Dataset::getnumglobalsamples() const {
    return num_global_samples;
}

const size_t Dataset::getnumlocalsamples() const {
...
void Dataset::setnumlocalsamples(size_t num) {
    num_local_samples = num;
}
...
bool Dataset::readsparse(Comm *comm) {
