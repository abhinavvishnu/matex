from keras.layers import Convolution2D, Dense, Dropout, MaxPooling2D, Input, Flatten, merge, AveragePooling2D, \
    Reshape, BatchNormalization, Activation, ZeroPadding2D
from keras_layers import LRN2D, PoolHelper
...
class LeNet3:
    def __init__(self):
        ...
        self.y_ = Input(shape=(10,))
        y = Convolution2D(20, 5, 5, W_regularizer=l2(0.0001), b_regularizer=l2(0.0001), border_mode='same',
                          activation='relu')(self.x)
        y = MaxPooling2D(strides=(2, 2), border_mode='same')(y)
        y = Convolution2D(50, 5, 5, W_regularizer=l2(0.0001), b_regularizer=l2(0.0001), border_mode='same',
                          activation='relu')(y)
        y = MaxPooling2D(strides=(2, 2), border_mode='same')(y)
        y = Flatten()(y)
        y = Dense(500, activation='relu', W_regularizer=l2(0.0001), b_regularizer=l2(0.0001))(y)
        self.y = Dense(10, activation='softmax', W_regularizer=l2(0.0001), b_regularizer=l2(0.0001))(y)
...
class Cifar10Net:
    def __init__(self):
        self.x = Input(shape=(32 * 32 * 3,))
        self.y_ = Input(shape=(10,))
        y = Reshape((3, 32, 32))(self.x)
        y = Convolution2D(32, 5, 5, W_regularizer=l2(0.004), b_regularizer=l2(0.004), border_mode='same',
                          activation='relu')(y)
        y = MaxPooling2D(pool_size=(3, 3), strides=(2, 2), border_mode='same')(y)
        y = Convolution2D(32, 5, 5, W_regularizer=l2(0.004), b_regularizer=l2(0.004), border_mode='same',
                          activation='relu')(y)
        y = AveragePooling2D(pool_size=(3, 3), strides=(2, 2), border_mode='same')(y)
        y = Convolution2D(64, 5, 5, W_regularizer=l2(0.004), b_regularizer=l2(0.004), border_mode='same',
                          activation='relu')(y)
        y = AveragePooling2D(pool_size=(3, 3), strides=(2, 2), border_mode='same')(y)
        y = Flatten()(y)
        y = Dense(64, activation='relu', W_regularizer=l2(0.004), b_regularizer=l2(0.004))(y)
        self.y = Dense(10, activation='softmax', W_regularizer=l2(0.004), b_regularizer=l2(0.004))(y)
