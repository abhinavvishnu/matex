...
class DataSet:
    def __init__(self, data_name, train_batch_size=None, test_batch_size=None, normalize=1.0, file1=None, file2=None,
        ...
        if self.dataset.lower() == "mnist":
           ...
           self.training_data, self.training_labels = read_pnetcdf(self.file1)
           if file2:
               self.testing_data, self.testing_labels = read_pnetcdf(self.file2)
            ...
            self.read_csv(self.file1, validation_percentage=valid_pct, test_percentage=test_pct)
...
if __name__ == '__main__':
    ...
    DataSet("PNETCDF", file1="mnist_train.nc")
