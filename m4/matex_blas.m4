...
AC_DEFUN([MATEX_F77_BLAS_TEST], [AC_LANG_CONFTEST([AC_LANG_PROGRAM([],
[[      implicit none
...
AC_DEFUN([MATEX_C_BLAS_TEST], [AC_LANG_CONFTEST([AC_LANG_PROGRAM(
[#ifdef __cplusplus
extern "C" {
#endif
char cgemm ();
...
# MATEX_C_RUN_BLAS_TEST
# ------------------
# Test the C linker.
# Clears BLAS_LIBS on failure.  Sets matex_blas_ok=yes on success.
AC_DEFUN([MATEX_C_RUN_BLAS_TEST], [
   AC_LANG_PUSH([C])
   MATEX_C_BLAS_TEST()
...
# MATEX_F77_RUN_BLAS_TEST
# --------------------
# Test the Fortran 77 linker.
# Clears BLAS_LIBS on failure.  Sets matex_blas_ok=yes on success.
AC_DEFUN([MATEX_F77_RUN_BLAS_TEST], [
...
# MATEX_BLAS([ACTION-IF-FOUND[, ACTION-IF-NOT-FOUND]])
# -------------------------------------------------
